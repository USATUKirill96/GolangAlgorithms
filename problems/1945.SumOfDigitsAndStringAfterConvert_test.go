...
//You are given a string input consisting of lowercase English letters, and an integer k.

//First, convert input into an integer by replacing each letter with its position in the alphabet
...
//For example, if input = "zbax" and k = 2, then the resulting integer would be 8 by the following operations:
